...
try{
   ...
   PreparedStatement ps=con.prepareStatement("update EMAIL set email_id=? where SSN=?");
  ...
  if(i>0)
  {
 out.print("Your email is successfully updated"); 
...
catch(Exception e){out.print("Your email is not updated"+e);
out.print("<center><a href='modifyDetails.html'>BACK</a>");}
%>   
</body>
</html>