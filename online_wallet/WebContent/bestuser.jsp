...
PreparedStatement st=con.prepareStatement("select Identifier, count(Identifier) as BestUser from SEND_TRANSACTION where Date_Time between ? and ? ");
st.setString(1,from);
st.setString(2,end);
...
while(rs.next())
	...
	int BestUser=rs.getInt("BestUser");
	String Identifier=rs.getString("Identifier");
	
    	
	out.print("<table>");
	out.print("<tr>");
	out.print("<td>"+"Best User ="+Identifier+"\t Total Number of Transaction = "+BestUser+"</td>");
	out.print("</tr>");
